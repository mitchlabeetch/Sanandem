...
{#if !dismissed}
<div class="bg-red-900/90 border-t-4 border-red-500 text-white px-4 py-3 shadow-lg sticky top-0 z-50" role="alert">
    <div class="container mx-auto flex items-start justify-between gap-4">
        <div class="flex-1">
            ...
            <p class="text-sm leading-relaxed">
                ...
                <a href="/disclaimer" class="underline hover:text-red-200 font-semibold">Read full disclaimer</a>
            </p>
        </div>
        <button 
            onclick={dismiss}
            class="flex-shrink-0 text-white hover:text-red-200 transition-colors p-1 rounded focus:outline-none focus:ring-2 focus:ring-red-300"
